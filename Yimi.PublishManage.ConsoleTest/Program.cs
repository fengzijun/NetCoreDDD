...
namespace Yimi.PublishManage.ConsoleTest
{
    class Program
    {
        static void Main(string[] args)
        {
            //var ldappath = FriendlyDomainToLdapDomain("yimihaodi.net");
            //Console.WriteLine($"ldappath:{ldappath}");
            //EnumerateDomains();
            //EnumerateOU("yimihaodi.net");
            //EnumerateDomainControllers();
            //var result = CreateUser("test");
            ////var result = CreateUserAccount("test", "!QAZ2wsx");
            ////bool result = IsUserExists("yimihaodi.net", "test");
        ...
        private static void GetDomainUsers()
        {
