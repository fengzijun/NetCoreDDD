...
using Yimi.PublishManage.Framework.Validators;

namespace Yimi.PublishManage.Web.Validators.Customer
{
    //public class RegisterValidator : BaseYimiValidator<RegisterModel>
    //{
