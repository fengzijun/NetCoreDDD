...
namespace Yimi.PublishManage.Web.Infrastructure.Installation
{
    /// <summary>
    ...
    public partial class InstallationLocalizationService : IInstallationLocalizationService
    {
        ...
        /// </summary>
        private const string LANGUAGE_COOKIE_NAME = ".Yimi.PublishManage.installation.lang";
            ...
            foreach (var filePath in Directory.EnumerateFiles(CommonHelper.MapPath("~/App_Data/Localization/Installation/"), "*.xml"))
            {
                ...
                foreach (XmlNode resNode in resources)
                {
                    ...
                    if (resNameAttribute == null)
                        throw new YimiException("All installation resources must have an attribute Name=\"Value\".");
                    var resourceName = resNameAttribute.Value.Trim();
                    if (string.IsNullOrEmpty(resourceName))
                        throw new YimiException("All installation resource attributes 'Name' must have a value.'");

                    if (resValueNode == null)
                        throw new YimiException("All installation resources must have an element \"Value\".");
