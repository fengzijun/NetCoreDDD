...
namespace Yimi.PublishManage.Framework.Infrastructure.Extensions
{
    ...
    public static class ApplicationBuilderExtensions
    {
        ...
        /// </summary>
        /// <param name="application">Builder for configuring an application's request pipeline</param>
        public static void UseYimiExceptionHandler(this IApplicationBuilder application)
        {
            var YimiConfig = EngineContext.Current.Resolve<YimiConfig>();
            var hostingEnvironment = EngineContext.Current.Resolve<IHostingEnvironment>();
            bool useDetailedExceptionPage = YimiConfig.DisplayFullErrorStack || hostingEnvironment.IsDevelopment();
        ...
        {
            //var lang = EngineContext.Current.Resolve<Yimi.PublishManage.Services.Localization.ILanguageService>().GetAllLanguages();
        ...
        /// </summary>
        /// <param name="application">Builder for configuring an application's request pipeline</param>
        public static void UseYimiAuthentication(this IApplicationBuilder application)
        {                    
            application.UseMiddleware<Yimi.PublishManage.Framework.Middleware.AuthenticationMiddleware>();
        }
        ...
        /// </summary>
        /// <param name="application">Builder for configuring an application's request pipeline</param>
        public static void UseYimiMvc(this IApplicationBuilder application)
        {
