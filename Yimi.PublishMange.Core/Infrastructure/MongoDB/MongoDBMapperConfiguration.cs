...
namespace Yimi.PublishManage.Core.Infrastructure.MongoDB
{
    public class MongoDBMapperConfiguration
    {
        ...
        public static void RegisterMongoDBMappings(YimiConfig config)
        {
            ...
            BsonClassMap.RegisterClassMap<SqlPublishOrder>(cm =>
            {
                cm.AutoMap();
             //   cm.UnmapMember(s => s.YimiSqlProvider);
            });
