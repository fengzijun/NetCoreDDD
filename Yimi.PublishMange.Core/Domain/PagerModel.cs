...
namespace Yimi.PublishMange.Core.Domain
{
        ...
        public string FirstButtonText
        {
            get
            {
                return (!string.IsNullOrEmpty(firstButtonText)) ?
                    firstButtonText :
                    string.Empty;//_localizationService.GetResource("Pager.First");
            }
            set
            {
        ...
        public string LastButtonText
        {
            get
            {
                return (!string.IsNullOrEmpty(lastButtonText)) ?
                    lastButtonText :
                    string.Empty;// _localizationService.GetResource("Pager.Last");
            }
            set
            {
        ...
        public string NextButtonText
        {
            get
            {
                return (!string.IsNullOrEmpty(nextButtonText)) ?
                    nextButtonText :
                    string.Empty;// _localizationService.GetResource("Pager.Next");
            }
            set
            {
        ...
        public string PreviousButtonText
        {
            get
            {
                return (!string.IsNullOrEmpty(previousButtonText)) ?
                    previousButtonText :
                    string.Empty;// _localizationService.GetResource("Pager.Previous");
            }
            set
            {
        ...
        public string CurrentPageText
        {
            get
            {
                return (!string.IsNullOrEmpty(currentPageText)) ?
                    currentPageText :
                    string.Empty;// _localizationService.GetResource("Pager.CurrentPage");
            }
            set
            {
